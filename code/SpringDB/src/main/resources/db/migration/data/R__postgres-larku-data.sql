-- NoNoNotThisAtAll Remove Spaces $ { flyway : timestamp }
...
('Manoj-Flyway-Postgres','222 333-4444','1956-08-15', 'FULL_TIME'),
('Ana-Flyway-Postgres','222 333-7900','1978-03-10', 'PART_TIME'),
('Roberta-Flyway-Postgres','383 343-5879','2000-07-15', 'HIBERNATING'),
('Madhu-Flyway-Postgres','383 598-8279','1994-10-07', 'PART_TIME');

INSERT INTO StudentVersioned (NAME, PHONENUMBER, DOB, STATUS, VERSION) VALUES
('Manoj-Flyway-Postgres','222 333-4444','1956-08-15', 'FULL_TIME', 1),
('Ana-Flyway-Postgres','222 333-7900','1978-03-10', 'PART_TIME', 1),
('Roberta-Flyway-Postgres','383 343-5879','2000-07-15', 'HIBERNATING', 1),
('Madhu-Flyway-Postgres','383 598-8279','1994-10-07', 'PART_TIME', 1);
